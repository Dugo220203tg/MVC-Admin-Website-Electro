...
var currentPage = 1; // Thay thế bằng giá trị thực tế từ server
var totalPages = 10; // Thay thế bằng giá trị thực tế từ server
var visiblePages = 5;
...
function previewImage(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            // Clear any previous preview image and name
